...
test_that("Find good paths though caves under rules1", {
...
test_that("Find good paths though caves under rules2", {
  # expect_equal( get_cave_paths_count( ex1_cavelink_data, rules="rules_2"), 36 )
  # expect_equal( get_cave_paths_count( ex2_cavelink_data, rules="rules_2"), 103 )
  # expect_equal( get_cave_paths_count( ex3_cavelink_data, rules="rules_2"), 3509 )
  expect_equal( get_cave_paths_count( cavelink_data, rules="rules_2"), 3509 )
  # expect_equal( get_cave_paths_count( ex2_cavelink_data ), 19 )
  # skip_if (test_level < 2)
  # expect_equal( get_cave_paths_count( ex3_cavelink_data ), 226 )
  # expect_equal( get_cave_paths_count( cavelink_data ), 3708 )
